...
export declare let Switch: (<TTag extends React.ElementType<any> = "button">(props: Props<TTag, SwitchRenderPropArg, "value" | "name" | "onChange" | "checked" | SwitchPropsWeControl> & {
    ...
    Group: typeof Group;
    Label: (<TTag_1 extends React.ElementType<any> = "label">(props: Omit<import("@headlessui/react/dist/types").PropsOf<TTag_1>, "id" | ("as" | "children" | "refName" | "className")> & {
        as?: TTag_1 | undefined;
        children?: React.ReactNode | ((bag: {}) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
        refName?: string | undefined;
    } & (import("@headlessui/react/dist/types").PropsOf<TTag_1> extends {
        className?: any;
    } ? {
